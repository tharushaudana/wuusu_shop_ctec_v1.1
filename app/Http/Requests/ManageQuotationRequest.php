...
class ManageQuotationRequest extends FormRequest
{
                ...
                return [
                    ...
                    'quotation_data' => [
                        ...
                        function($attribute, $value, $fail) {
                            ...
                            $this->validateQuotationData($json, $fail);
                        }
                    ],
                ];
            case 'update':
    ...
    //### for modify 'quotation_data' into array after validation
    protected function passedValidation()
    {
        $quotation_data = json_decode($this->input('quotation_data'), true);

        //### resolve double
        foreach ($quotation_data as $i => $item) {
            $quotation_data[$i]['discount'] = $this->resolveDouble($item['discount']);
        }
    ...
    private function validateQuotationData($json, $fail) {
