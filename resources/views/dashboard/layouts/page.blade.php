    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item" href="{{ route('web.pages.my') }}">
                                    <i class="fas fa-user fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Profile
                                </a>
                                <a class="dropdown-item" href="{{ route('web.pages.my.sessions') }}">
                                    <i class="fas fa-key fa-sm fa-fw mr-2 text-gray-400"></i>
                                    Sessions
                                </a>
                                <a class="dropdown-item" href="{{ route('web.pages.my.activities') }}" target="_blank">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">@yield('title', 'Page of Wuusu Admin')</h1>
                    </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto" style="padding: 6px;">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; CTEC.LK 2023</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
