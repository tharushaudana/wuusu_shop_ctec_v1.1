...
<body>
        ...
        <table class="infotable">
            ...
            <td style="float: left;">
                <div style="width: 100%; text-align: right;">
                    <span style="font-size: 90px; letter-spacing: 20px;">QUOTATION</span>
                    <div style="float: right;">
                        <table class="datatable">
                            ...
                            <tbody>
                                <tr>
                                    <td><span class="text-bold" style="font-size: 18px;">Rs.{{ $data->quotation_data()->grand_total() }}</span></td>
    ...
    <main>
        ...
        <table class="datatable">
            ...
            @foreach ($data->quotation_data()->get() as $record)
            <tr>
                    ...
                    <table class="infotable">
                            ...
                            <td style="padding: 10px; text-align: right; background-color: {{ $colors['foreground_color_light'] }};">
                                <table>
                                    <tr>
                                        ...
                                        <td style="color: {{ $colors['text_color_light'] }}; font-size: 20px;"><strong>&nbsp;&nbsp;Rs.{{ number_format((float)$data->quotation_data()->sub_total(), 2, '.', '') }}</strong></td>
                                    </tr>
                                    <tr>
                                        <td style="color: {{ $colors['text_color_light'] }}; font-size: 20px;">TOTAL DISCOUNT:</td>
                                        <td style="color: {{ $colors['text_color_light'] }}; font-size: 20px;"><strong>&nbsp;&nbsp;Rs.{{ number_format((float)$data->quotation_data()->total_discount(), 2, '.', '') }}</strong></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        ...
                        <tr>
                            <td style="padding: 10px; text-align: right; background-color: {{ $colors['foreground_color_dark'] }};">
                                <div>
                                    <span style="color: {{ $colors['text_color_light'] }}; font-size: 25px;">TOTAL:<strong>&nbsp;&nbsp;Rs.{{ number_format((float)$data->quotation_data()->grand_total(), 2, '.', '') }}</strong></span>
                                </div>
                            </td>
                        </tr>
                    </table>
            ...
            <tr>
                <td style="vertical-align: top;">
                    <div style="text-align:center; width:100%;">
                        <div class="hr"></div>
                        <h5 style="font-family: typewriter; color:{{ $colors['text_color_warning'] }};">Valid Until: {{ $data->validuntil }}</h5>
                    </div>
